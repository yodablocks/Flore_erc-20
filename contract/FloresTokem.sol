...
interface ERC20 {
    function totalSupply() external view returns (uint floresTokenTotalSupply);
...
contract FloresToken is ERC20 {
    using SafeMath for uint256;

	string private _name = "Flores Token";
    string private _symbol = "FLOREs";
    ...
    function totalSupply() override external view returns (uint floresTokenTotalSupply) {
        return _totalSupply;
    }
